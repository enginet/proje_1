<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="bankadan-liste.aspx.cs" Inherits="PL.bankadan_liste" %>
                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:Repeater ID="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/bankadan-liste.aspx?kategoriId={0}&tur={1}&cat={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ul>
                                    </li>
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="active"><a href='<%= Page.ResolveUrl("~/bankadan-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]+"&cat="+Request.QueryString["cat"]) %>' role="tab">Banka
