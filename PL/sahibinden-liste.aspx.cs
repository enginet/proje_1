...
namespace PL
{
    public partial class sahibinden_liste : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ilanRepeater.DataSource = ilanb.list_admin(9, 1, Request.QueryString["kategoriId"], Request.QueryString["tur"]);
                ...
                {
                    ilanRepeater.DataSource = ilanb.list_admin(8, 1, Request.QueryString["kategoriId"]);
                    ilanRepeater.DataBind();
                }
            ...
            {
                ilanRepeater.DataSource = ilanb.list_admin(8, 1, Request.QueryString["cat"], Request.QueryString["tur"]);
                ilanRepeater.DataBind();
