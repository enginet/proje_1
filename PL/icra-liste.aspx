<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="icra-liste.aspx.cs" Inherits="PL.icra_liste" %>
                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:repeater id="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/icra-liste.aspx?kategoriId={0}&tur={1}&cat={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:repeater>
                                        </ul>
                                    </li>
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <span class="badge" runat="server" id="belediyeden"></span></a></li>
                                        <li class="active"><a href='<%= Page.ResolveUrl("~/icra-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]+"&cat="+Request.QueryString["cat"]) %>' role="tab">İcra
