    ...
    public partial class ilan_liste : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //    {
                //        ilanRepeater.DataSource =
                //        ilanRepeater.DataBind();
                //    }

                //    if ((Request.QueryString["cat"] != null || Request.QueryString["kategoriId"] == "4"))
                //    {
                //        ilanRepeater.DataSource = ilanb.list_admin(8, 3, Request.QueryString["cat"], Request.QueryString["tur"]);
                //        ilanRepeater.DataBind();
