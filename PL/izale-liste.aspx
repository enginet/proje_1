<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="izale-liste.aspx.cs" Inherits="PL.izale_liste" %>
                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:Repeater ID="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/izale-liste.aspx?kategoriId={0}&tur={1}&cat={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ul>
                                    </li>
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <span class="badge" runat="server" id="bankadan"></span></a></li>
                                        ...
                                        <li class="active"><a href='<%= Page.ResolveUrl("~/izale-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]+"&cat="+Request.QueryString["cat"]) %>' role="tab">İzale-i Şuyu
