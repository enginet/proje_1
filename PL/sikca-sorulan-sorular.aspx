<%@ Page Title="SSS" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="sikca-sorulan-sorular.aspx.cs" Inherits="PL.sikca_sorulan_sorular" %>
                            ...
                            <div id="headingOne" role="tab" class="panel-heading">
                                <h4 class="panel-title">
                                    <a aria-controls="collapseOne" aria-expanded="true" href="#collapseOne"
                                        data-parent="#accordion" data-toggle="collapse">How do I place an ad?
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div id="headingTwo" role="tab" class="panel-heading">
                                <h4 class="panel-title">
                                    <a aria-controls="collapseTwo" aria-expanded="false" href="#collapseTwo"
                                        data-parent="#accordion" data-toggle="collapse" class="collapsed">What does it cost to advertise?
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div id="headingThree" role="tab" class="panel-heading">
                                <h4 class="panel-title">
                                    <a aria-controls="collapseThree" aria-expanded="false" href="#collapseThree"
                                        data-parent="#accordion" data-toggle="collapse" class="collapsed">If I post an ad, will I also get more spam e-mails?
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div id="heading_04" role="tab" class="panel-heading">
                                <h4 class="panel-title">
                                    <a aria-controls="collapse_04" aria-expanded="false" href="#collapse_04"
                                        data-parent="#accordion" data-toggle="collapse" class="collapsed">How long will my ad remain on the website?
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div id="heading_05" role="tab" class="panel-heading">
                                <h4 class="panel-title">
                                    <a aria-controls="collapse_05" aria-expanded="false" href="#collapse_05"
                                        data-parent="#accordion" data-toggle="collapse" class="collapsed">I sold my item. How do I delete my ad?
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div id="heading_06" role="tab" class="panel-heading">
                                <h4 class="panel-title">
                                    <a aria-controls="collapse_06" aria-expanded="false" href="#collapse_06"
                                        data-parent="#accordion" data-toggle="collapse" class="collapsed">What is a wish list?
                                    </a>
                                </h4>
                            </div>
            ...
            <div class="row text-center featuredbox">
                <div class="col-sm-4 xs-gap">
                    <div class="inner">
                        ...
                        <p>
                            Ein herausragendes Beispiel für Story-Telling im modernen Webdesign. et suscipit sapien
