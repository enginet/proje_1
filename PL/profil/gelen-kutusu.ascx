<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="gelen-kutusu.ascx.cs" Inherits="PL.profil.gelen_kutusu" %>
<div class="col-sm-9 page-content">
    <div class="inner-box">
        <h2 class="title-2"><i class="icon-post"></i>İlan Mesajları </h2>
                                    ...
                                    <div class="item-list">
                                        ...
                                        <div class="col-sm-7 add-desc-box">
                                            <div class="add-details">
                                                <h5 class="add-title">
                                                    <asp:HyperLink NavigateUrl='<%# String.Format("~/profil/profil.aspx?control=mesaj-oku&to={0}&cla={1}", Eval("kullaniciId") ,Eval("ilanId"))%>' runat="server">
<%# Eval("baslik") %> </asp:HyperLink></h5>
                                        ...
                                        <div class="col-sm-3 text-right  price-box">
                                            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-danger  btn-sm make-favorite" NavigateUrl='<%# String.Format("~/profil/profil.aspx?control=gelen-kutusu&proc={0}&to={1}&cla={2}", 1, Eval("kullaniciId") ,Eval("ilanId"))%>'><i
