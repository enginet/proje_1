<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="reklam-onay-bekleyen.ascx.cs" Inherits="PL.profil.reklam_onay_bekleyen" %>
...
<%--                                            <asp:HyperLink ID="HyperLink3" runat="server" CssClass="btn btn-success btn-sm make-favorite" NavigateUrl='<%# String.Format("~/profil/profil.aspx?control=reklam-onay-bekleyen&ads={0}",Eval("verilenReklamId"))%>'><i
