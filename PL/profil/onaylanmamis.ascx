<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="onaylanmamis.ascx.cs" Inherits="PL.profil.onaylanmamis" %>

<div class="col-sm-9 page-content">
    <div class="inner-box">
        <h2 class="title-2"><i class="fa fa-times"></i>Onaylanmamış İlanlar </h2>
                    ...
                    <div class="category-list">
                            ...
                            <div class="pull-left col-xs-6">
                                <div class="breadcrumb-list">
                                    <a href="#" class="current">
                                        <span>Onaylanmamış Tüm İlanlar</span></a>
                                </div>
                            </div>
                        ...
                        <div class="tab-box  save-search-bar text-center">
                            <a href=""><i class=" icon-plus"></i>
                                Onaylanmamış İlanınız Bulunmamaktadır. </a>
                        </div>
                    </div>
