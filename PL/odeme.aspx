<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="odeme.aspx.cs" Inherits="PL.odeme" %>
                                        ...
                                        <ContentTemplate>
                                            <section class="content" style="background: #fff; padding-bottom: 15px;">
                                                ...
                                                <div class="col-xs-1 col-xs-offset-11">
                                                    <button id="devam" class="btn btn-success" style="float: right; margin-top: 15px;">Devam</button>
                                                </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h4>Ödeme</h4>
                                                                <p style="font-size: 16px;">Toplam <span id="odeme_tutar" style="font-weight: bold;"></span>tutarında ödemeniz vardır. Bu ödemeyi Eft & havale yoluyla hesap numaramıza yatırmanız gerekmektedir.</p>
                                                            </div>
