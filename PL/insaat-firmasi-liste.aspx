<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="insaat-firmasi-liste.aspx.cs" Inherits="PL.insaat_firmasi_liste" %>
                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:Repeater ID="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/insaat-firmasi-liste.aspx?kategoriId={0}&tur={1}&sub={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ul>
                                    </li>
                    ...
                    <div class="category-list">
                        <div class="tab-box ">
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                <li><a href='<%= Page.ResolveUrl("~/ilan-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]) %>' role="tab">Tüm İlanlar <span class="badge">228,705</span></a>
                                </li>
                                ...
                                <li class="active"><a href='<%= Page.ResolveUrl("~/insaat-firmasi-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]) %>' role="tab">İnşaat Firması
                                    <span class="badge">18,705</span></a></li>
