...
{
    public partial class konut_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                konutOzelRepeater.DataSource = ozellikb.selectFieldList(68);
                konutOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in konutOzelRepeater.Controls)
                    {
