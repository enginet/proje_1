...
{
    public partial class manzara : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                manzaraRepeater.DataSource = ozellikb.selectFieldList(76);
                manzaraRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in manzaraRepeater.Controls)
                    {
