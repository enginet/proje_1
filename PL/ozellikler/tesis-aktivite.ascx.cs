...
{
    public partial class tesis_aktivite : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                tesisAktiRepeater.DataSource = ozellikb.selectFieldList(94);
                tesisAktiRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in tesisAktiRepeater.Controls)
                    {
