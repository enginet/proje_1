...
{
    public partial class engelliuygun : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                engelRepeater.DataSource = ozellikb.selectFieldList(46);
                engelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in engelRepeater.Controls)
                    {
