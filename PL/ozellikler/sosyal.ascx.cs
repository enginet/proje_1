...
{
    public partial class sosyal : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                sosyalRepeater.DataSource = ozellikb.selectFieldList(92);
                sosyalRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in sosyalRepeater.Controls)
                    {
