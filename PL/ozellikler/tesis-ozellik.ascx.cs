...
{
    public partial class tesis_ozellikleri : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                tesisOzelRepeater.DataSource = ozellikb.selectFieldList(95);
                tesisOzelRepeater.DataBind();
            }
            ...
            if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
            {
                ...
                foreach (Control item in tesisOzelRepeater.Controls)
                {
