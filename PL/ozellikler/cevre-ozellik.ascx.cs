...
{
    public partial class cevre_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                cevreOzelRepeater.DataSource = ozellikb.selectFieldList(33);
                cevreOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in cevreOzelRepeater.Controls)
                    {
