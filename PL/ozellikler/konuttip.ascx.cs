...
{
    public partial class konuttip : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                konutTipRepeater.DataSource = ozellikb.selectFieldList(70);
                konutTipRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in konutTipRepeater.Controls)
                    {
