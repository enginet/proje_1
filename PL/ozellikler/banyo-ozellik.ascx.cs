...
{
    public partial class banyo_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                banyoOzelRepeater.DataSource = ozellikb.selectFieldList(15);
                banyoOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in banyoOzelRepeater.Controls)
                    {
