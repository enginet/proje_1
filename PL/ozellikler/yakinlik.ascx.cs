...
{
    public partial class yakinlik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                yakinRepeater.DataSource = ozellikb.selectFieldList(98);
                yakinRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in yakinRepeater.Controls)
                    {
