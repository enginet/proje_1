...
{
    public partial class yeme_icme : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                yemeRepeater.DataSource = ozellikb.selectFieldList(102);
                yemeRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in yemeRepeater.Controls)
                    {
