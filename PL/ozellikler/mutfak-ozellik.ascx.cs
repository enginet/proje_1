...
{
    public partial class mutfak_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                mutfakOzelRepeater.DataSource = ozellikb.selectFieldList(80);
                mutfakOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in mutfakOzelRepeater.Controls)
                    {
