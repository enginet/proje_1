...
{
    public partial class konaklama_sekli : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                konaklamaRepeater.DataSource = ozellikb.selectFieldList(66);
                konaklamaRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in konaklamaRepeater.Controls)
                    {
