...
{
    public partial class ulasim : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ulasimRepeater.DataSource = ozellikb.selectFieldList(97);
                ulasimRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in ulasimRepeater.Controls)
                    {
