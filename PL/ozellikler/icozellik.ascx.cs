...
{
    public partial class icOzellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                icOzelRepeater.DataSource = ozellikb.selectFieldList(52);
                icOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in icOzelRepeater.Controls)
                    {
