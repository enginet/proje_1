...
{
    public partial class ic_dekorasyon : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                icDekoRepeater.DataSource = ozellikb.selectFieldList(51);
                icDekoRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in icDekoRepeater.Controls)
                    {
