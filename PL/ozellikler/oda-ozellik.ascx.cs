...
{
    public partial class oda_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                odaOzelRepeater.DataSource = ozellikb.selectFieldList(81);
                odaOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in odaOzelRepeater.Controls)
                    {
