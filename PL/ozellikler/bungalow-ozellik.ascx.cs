...
{
    public partial class bungalow_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                bungaOzelRepeater.DataSource = ozellikb.selectFieldList(28);
                bungaOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in bungaOzelRepeater.Controls)
                    {
