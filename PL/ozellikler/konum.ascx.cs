...
{
    public partial class konum : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                konumRepeater.DataSource = ozellikb.selectFieldList(67);
                konumRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in konumRepeater.Controls)
                    {
