...
{
    public partial class Cephe : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                cepheRepeater.DataSource = ozellikb.selectFieldList(31);
                cepheRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in cepheRepeater.Controls)
                    {
