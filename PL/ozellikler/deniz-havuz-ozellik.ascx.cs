...
{
    public partial class deniz_havuz_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                denizOzelRepeater.DataSource = ozellikb.selectFieldList(35);
                denizOzelRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in denizOzelRepeater.Controls)
                    {
