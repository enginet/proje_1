...
{
    public partial class dis_cephe_ozellik : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                disCepheRepeater.DataSource = ozellikb.selectFieldList(43);
                disCepheRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in disCepheRepeater.Controls)
                    {
