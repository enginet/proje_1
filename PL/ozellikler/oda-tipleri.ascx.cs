...
{
    public partial class oda_tipleri : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                odaTipRepeater.DataSource = ozellikb.selectFieldList(84);
                odaTipRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in odaTipRepeater.Controls)
                    {
