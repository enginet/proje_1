...
{
    public partial class ortak_kullanim : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ortakKullanimRepeater.DataSource = ozellikb.selectFieldList(86);
                ortakKullanimRepeater.DataBind();
                ...
                if (Request.QueryString["page"] == "duzenle" || Request.QueryString["ilan"] != "")
                {
                    ...
                    foreach (Control item in ortakKullanimRepeater.Controls)
                    {
