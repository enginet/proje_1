                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <span class="badge" runat="server" id="ozellestirme_dairesinden"></span></a></li>
                                        <li class="active"><a href='<%= Page.ResolveUrl("~/kamu-kurumlari-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]) %>' role="tab">Kamu Kurumları
