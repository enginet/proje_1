                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <span class="badge" runat="server" id="milli_hazineden"></span></a></li>
                                        <li class="active"><a href='<%= Page.ResolveUrl("~/ozellestirme-idaresi-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]) %>' role="tab">Özelleştirme İdaresi
