                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:repeater id="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/emlak-ofis-liste.aspx?kategoriId={0}&tur={1}&sub={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:repeater>
                                        </ul>
                                    </li>
                    ...
                    <div class="category-list">
                        <div class="tab-box ">
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                <li><a href='<%= Page.ResolveUrl("~/ilan-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]) %>' role="tab"
