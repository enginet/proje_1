...
{
    public partial class duzenle_magaza_tipi : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                rdStandart.SelectedValue = magazab.search(Convert.ToInt32(Request.QueryString["edit"])).magazaKategoriId.ToString();
                rdPremium.SelectedValue = magazab.search(Convert.ToInt32(Request.QueryString["edit"])).magazaKategoriId.ToString();
            }
        ...
        protected void devam_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/management/anaYonetim/magazaYonetimi/magaza.aspx?page=duzenle-icerik&edit="+Request.QueryString["edit"]+"&sto=" + Request.QueryString["sto"] + "&cat=1&pac=" + rdStandart.SelectedValue);
            }
            else
            {
                Response.Redirect("~/management/anaYonetim/magazaYonetimi/magaza.aspx?page=duzenle-icerik&edit=" + Request.QueryString["edit"] + "&sto=" + Request.QueryString["sto"] + "&cat=1&pac=" + rdPremium.SelectedValue);
            }
        }
