<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="duzenle-kategori-secimi.ascx.cs" Inherits="PL.management.anaYonetim.magazaYonetimi.duzenle_kategori_secimi" %>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Mağaza Detay Düzenle
            <small>buradan mağaza detay düzenleyebilirsiniz.</small>
        </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-primary coupon">
                                <div class="panel-footer">
                                    <asp:RadioButtonList ID="rdKategori" runat="server" Height="59px" Width="922px">
                                    </asp:RadioButtonList>
                                </div>
                            </div>
