<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ekle.ascx.cs" Inherits="PL.management.anaYonetim.ozelAlanYonetimi.ekle" %>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Özel Alan Ekle
            <small>buradan özel alan ekleyebilirsiniz.</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Özel Alan Ekle Formu</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div role="form">
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="txtOzelAlan">Özel Alan Adı</label>
                                    <input type="text" class="form-control" id="txtOzelAlan" placeholder="Cephe">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
