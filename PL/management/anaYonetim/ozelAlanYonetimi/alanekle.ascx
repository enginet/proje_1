<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="alanekle.ascx.cs" Inherits="PL.management.anaYonetim.ozelAlanYonetimi.secilebilirAlanEkle" %>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Seçilebilir Alan Ekle
            <small>buradan seçilebilir alan ekleyebilirsiniz.</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Seçilebilir Alan Ekle Formu</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div role="form">
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Seçilebilir Özel Alanlar</label>
                                    <asp:DropDownList CssClass="form-control select2" Style="width: 100%;" ID="drpOzelAlan" runat="server"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label for="txtAlan">Seçlebilir Alan Adı</label>
                                    <input type="text" class="form-control" id="txtAlan" placeholder="Doğu">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
