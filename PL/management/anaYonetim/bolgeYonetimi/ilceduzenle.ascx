<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ilceduzenle.ascx.cs" Inherits="PL.management.anaYonetim.bolgeYonetimi.ilceduzenle" %>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>İlçe Düzenle
            <small>buradan ilçe düzenleyebilirsiniz.</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">İlçe Bilgileri</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div role="form">
                        <div class="box-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtIlce" runat="server">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
