<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="duzenle.ascx.cs" Inherits="PL.management.anaYonetim.kategoriYonetimi.duzenle" %>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Kategori Düzenle
            <small>buradan kategori düzenleyebilirsiniz.</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Kategori Düzenle Formu</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div role="form">
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtKategori" runat="server">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
