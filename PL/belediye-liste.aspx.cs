...
namespace PL
{
    public partial class belediye_liste : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ilanRepeater.DataSource = ilanb.list_admin(9, 2, Request.QueryString["kategoriId"], Request.QueryString["tur"], 1);
                ...
                {
                    ilanRepeater.DataSource = ilanb.list_admin(8, 2, Request.QueryString["kategoriId"], 1);
                    ilanRepeater.DataBind();
                }
            ...
            {
                ilanRepeater.DataSource = ilanb.list_admin(8, 2, Request.QueryString["cat"], Request.QueryString["tur"], 1);
                ilanRepeater.DataBind();
