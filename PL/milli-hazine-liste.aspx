<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="milli-hazine-liste.aspx.cs" Inherits="PL.milli_hazine_liste" %>
                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:repeater id="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/milli-hazine-liste.aspx?kategoriId={0}&tur={1}&cat={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:repeater>
                                        </ul>
                                    </li>
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <span class="badge" runat="server" id="icradan"></span></a></li>
                                        <li class="active"><a href='<%= Page.ResolveUrl("~/milli-hazine-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"]+"&cat="+Request.QueryString["cat"]) %>' role="tab">Milli Hazine
