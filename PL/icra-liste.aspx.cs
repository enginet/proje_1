    ...
    public partial class icra_liste : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["kategoriId"] != "4" & Request.QueryString["cats"] == null)
                {
            ...
            {
                ilanRepeater.DataSource = ilanb.list_admin(8, 2, Request.QueryString["cat"], Request.QueryString["tur"], 2);
                ilanRepeater.DataBind();
