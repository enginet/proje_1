                    ...
                    <aside>
                        <div class="inner-box">
                            <div class="categories-list  list-filter">
                                <asp:LinkButton ID="LinkButton1" CssClass="btn btn-danger btn-block" Style="margin-top: 17px;" runat="server"><i class="fa fa-map-marker"></i> Akıllı Harita</asp:LinkButton>
                                    ...
                                    <li><a href="#"><span class="title"><strong runat="server" id="ustStr"></strong></span><span
                                        ...
                                        <ul class=" list-unstyled long-list">
                                            <asp:Repeater ID="kategoriRepeater" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <asp:HyperLink ID="hypKategori" runat="server" NavigateUrl='<%# String.Format("~/ilan-liste.aspx?kategoriId={0}&tur={1}&cat={2}",Request.QueryString["kategoriId"],Request.QueryString["tur"], Eval("kategoriId") ) %>'><%# Eval("kategoriAdi") %><span class="count">(143)</span></asp:HyperLink></li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ul>
                                    </li>
                    ...
                    <div class="category-list">
                        <div class="tab-box ">
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                <li class="active"><a href='<%= Page.ResolveUrl("~/ilan-liste.aspx?kategoriId=" + Request.QueryString["kategoriId"]+"&tur=" + Request.QueryString["tur"] +"&cat=" + Request.QueryString["cat"]) %>' role="tab">Tüm İlanlar <span class="badge" runat="server" id="tum_ilanlar"></span></a>
                                </li>
